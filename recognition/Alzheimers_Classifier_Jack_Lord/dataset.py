...
#Data
transform = transforms.Compose([transforms.Resize(256), transforms.CenterCrop(224), transforms.ToTensor(), transforms.Normalize(0.11559005826711655, 0.2252865880727768)])
...
train_loader = torch.utils.data.DataLoader(subset_trainset, batch_size=150, shuffle=True)
...
test_loader = torch.utils.data.DataLoader(subset_testset, batch_size=150, shuffle=False)
