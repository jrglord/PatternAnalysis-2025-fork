...
train_loader = torch.utils.data.DataLoader(subset_trainset, batch_size=300, shuffle=True)
...
test_loader = torch.utils.data.DataLoader(subset_testset, batch_size=300, shuffle=False)
