...
train_subset_size = len(full_trainset)//3
...
train_loader = torch.utils.data.DataLoader(subset_trainset, batch_size=100, shuffle=True)
...
test_subset_size = len(full_testset)//3
...
test_loader = torch.utils.data.DataLoader(subset_testset, batch_size=100, shuffle=False)
